...
const UserProfile = ({ user }) => {
  ...
  return (
    ...
    <div className="max-w-md mx-auto bg-purple-50 p-8 rounded-2xl shadow-2xl border border-purple-200">
      ...
      <Link href={`/user/${user._id}/favorites`} className=" w-80 mx-auto mt-4 font-semibold text-red-700 border border-red-700 hover:bg-red-700 hover:text-white py-2 px-4 rounded-tl-3xl rounded-br-3xl flex items-center capitalize"><BiHeart className='mr-4' />{user.name}'s Favorite Recipes</Link>
      </div>
